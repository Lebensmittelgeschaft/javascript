...
*Based on [Airbnb's](https://github.com/airbnb/javascript) Style Guide*

> **Note**: this is a forming guideline for our company derived from the Airbnb popular Javascript Style Guide. If you do not agree with the things listed or have some to add please contact us or make a pull request. A linter should be added as well in the future.
